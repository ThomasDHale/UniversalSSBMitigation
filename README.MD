This script will configure the relevant registry keys to enable Windows OS mitigations for the CVE-2018-393 Speculative Store Bypass (SSB) vulnerability.
